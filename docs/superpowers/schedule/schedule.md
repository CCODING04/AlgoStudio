...
| R9 | 🔄 进行中 | Sprint 4 | 最终评审 + 收尾 | R9-BE: ✅ Security fixes (commit 1c9e550) - require_permission, dataset access filtering, encryption key fail-fast, Redis password, SQL wildcard escaping |
